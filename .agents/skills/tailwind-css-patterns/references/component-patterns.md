...
<div class="overflow-hidden rounded-lg bg-white shadow-lg">
	...
	<div class="p-6">
		...
		<button class="rounded bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700">Action</button>
	</div>
</div>
```
...
<form class="mx-auto max-w-md space-y-6">
	...
	<div>
		...
		<input type="password" class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500" />
	</div>
	...
	<button type="submit" class="w-full rounded-lg bg-blue-600 px-4 py-2 font-semibold text-white transition hover:bg-blue-700">Sign In</button>
</form>
```
